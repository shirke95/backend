...
SECRET_KEY = "django-insecure-z4uhykcqrijn!o_ds+ch5$u3s-48i$(ds0stt1+a6hnrkkz=^5"
...
INSTALLED_APPS = [
    ...
    #
    "base.apps.BaseConfig",  # Ensure this matches your app name
    #
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Adjust this if you have a different static files directory
]

MEDIA_ROOT = "static/images/"  # Directory where uploaded files will be stored
MEDIA_URL = "images/"
